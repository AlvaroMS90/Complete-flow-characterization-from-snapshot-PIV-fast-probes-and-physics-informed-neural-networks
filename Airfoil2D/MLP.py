...
# Read data
data = scipy.io.loadmat('Airfoil2D_PIV.mat')
...
# Dimensions
dim_T_PIV = T_PIV.shape[1]
dim_N_PIV = T_PIV.shape[0]
dim_T_probe = U_probe.shape[1]
dim_N_probe = U_probe.shape[0]
dim_T_test_PIV = T_test_PIV.shape[1]
dim_N_test_PIV = T_test_PIV.shape[0]
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % num_epochs == 0:
        ...
        scipy.io.savemat('Airfoil_MLP.mat',
